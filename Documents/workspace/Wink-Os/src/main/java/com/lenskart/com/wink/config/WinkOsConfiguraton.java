package com.lenskart.com.wink.config;
...
public class WinkOsConfiguraton extends ResourceServerConfigurerAdapter {
	/**
	...
	public void configure(HttpSecurity http) throws Exception {
		// @formatter:off
		http.requestMatchers().antMatchers("/**").and().authorizeRequests().antMatchers(HttpMethod.GET, "/**").permitAll()
